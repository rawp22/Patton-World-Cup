...
.leaderboard-table { min-width:650px; } .leaderboard-table .rank-col { width:58px; } .leaderboard-table .user-col { width:16%; } .leaderboard-table .score-col { width:72px; } .leaderboard-table .ko-col { width:92px; } .leaderboard-table .draws-col { width:82px; }
