...
.points { font-weight:950; } .points:not(.zero-points) { box-shadow:inset 0 0 0 1px var(--line); } .points.zero-points { opacity:.34; color:var(--muted); font-weight:650; } .scenario-muted { opacity:.34; color:var(--muted); font-weight:650; } .scenario-active { color:var(--gold-dark); font-weight:950; background:#fff7dc; } .impact-head.scenario-active { background:#f1cf6a; } .impact-head.scenario-muted { background:#faf3df; }
